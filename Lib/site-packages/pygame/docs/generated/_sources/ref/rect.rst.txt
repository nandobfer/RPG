...
.. class:: Rect
   ...
   The Rect object has several virtual attributes which can be used to main and
   align the Rect:
   ...
   .. versionadded:: 1.9.2
      The Rect class can be subclassed. Methods such as ``copy()`` and ``main()``
   ...
   .. method:: move_ip
      ...
      Same as the ``Rect.main()`` method, but operates in place.
   ...
   .. method:: fit
      ...
      | :sl:`resize and main a rectangle with aspect ratio`
      | :sg:`fit(Rect) -> Rect`
