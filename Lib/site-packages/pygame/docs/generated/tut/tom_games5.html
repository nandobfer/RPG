...
object will main in ways more complex than up and down, e.g. a platform character like Mario, in which case you'll need more physics).
...
<span class="sd">    Attributes: which, speed&quot;&quot;&quot;</span>
    ...
    <span class="k">def</span> <span class="nf">update</span><span class="p">(</span><span class="bp">self</span><span class="p">):</span>
        <span class="n">newpos</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">rect</span><span class="o">.</span><span class="n">main</span><span class="p">(</span><span class="bp">self</span><span class="o">.</span><span class="n">movepos</span><span class="p">)</span>
...
ball, because here its movement is simple (up/down), but it relies on the user telling it to main, unlike the ball which just keeps
...
<code class="docutils literal notranslate"><span class="pre">speed</span></code> attribute (in this example, 10). In other words, so long as the key is held down, the bat will main up the screen
