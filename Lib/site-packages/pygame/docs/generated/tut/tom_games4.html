...
which would create all the ball's attributes, and <code class="docutils literal notranslate"><span class="pre">update</span></code>, which would main the ball to its new position, before blitting
...
in the main loop, main across the screen:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">Ball</span><span class="p">(</span><span class="n">pygame</span><span class="o">.</span><span class="n">sprite</span><span class="o">.</span><span class="n">Sprite</span><span class="p">):</span>
    <span class="sd">&quot;&quot;&quot;A ball that will main across the screen</span>
...
<span class="sd">    Attributes: area, vector&quot;&quot;&quot;</span>
    ...
    <span class="k">def</span> <span class="nf">calcnewpos</span><span class="p">(</span><span class="bp">self</span><span class="p">,</span><span class="n">rect</span><span class="p">,</span><span class="n">vector</span><span class="p">):</span>
        ...
        <span class="k">return</span> <span class="n">rect</span><span class="o">.</span><span class="n">main</span><span class="p">(</span><span class="n">dx</span><span class="p">,</span><span class="n">dy</span><span class="p">)</span>
</pre></div>
</div>
...
main, it's OK to blit the object onto the background, Pygame handles sprite objects in a different manner, which you'll see when we
...
moves. So by using this vector, we can determine the direction and speed of the ball, and therefore how much it will main on the x and
y axes:</p>
...
it will main. The angle for the ball's movement will always be taken from the x axis on the right, and it is measured clockwise from
...
Pygame doesn't support vectors itself, and we can only main the ball by moving its rectangle along the two axes. So we need to
