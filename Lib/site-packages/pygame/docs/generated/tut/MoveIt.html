...
<section id="pygame-tutorials-help-how-do-i-main-an-image">
<section id="help-how-do-i-main-an-image">
<h2>Help! How Do I Move An Image?<a class="headerlink" href="#help-how-do-i-main-an-image" title="Permalink to this headline">¶</a></h2>
...
out  how to make an image main around the screen. Without understanding
...
is needed to &quot;main&quot; an image. We don't actually main anything at all. We
...
on the screen, but it cannot main anywhere. Perhaps now that our screen
is  just a list of numbers, it's easier to see how to main him?</p>
</section>
<section id="making-the-hero-main">
<h3>Making The Hero Move<a class="headerlink" href="#making-the-hero-main" title="Permalink to this headline">¶</a></h3>
...
<p>Now it is pretty easy to main him to a new position. We simply change
...
before the last time we tried to make him main. But this time we have the
extra information we need to main him properly.</p>
</section>
<section id="making-the-hero-main-take-2">
<h3>Making The Hero Move (Take 2)<a class="headerlink" href="#making-the-hero-main-take-2" title="Permalink to this headline">¶</a></h3>
<p>This time it will be easy to main the hero around. First we will erase
...
same  code to main him to the left again.</p>
...
but we can certainly do better than that. Now let's main the player
...
methods which help you main and position them. In our next examples we will
...
<p>To make something appear to main smoothly, we only want to main it a couple
pixels at a time. Here is the code to make an object main smoothly across
...
<span class="gp">... </span>    <span class="n">position</span> <span class="o">=</span> <span class="n">position</span><span class="o">.</span><span class="n">main</span><span class="p">(</span><span class="mi">2</span><span class="p">,</span> <span class="mi">0</span><span class="p">)</span>     <span class="c1">#main player</span>
...
main and draw our game objects. (We'll also erase them before they main,
too)</p>
</section>
...
our game object. This object will have a function to main itself, and then
we can create as many as we like. The functions to draw and main the object
need to work in a way where they only main one frame (or one step) at a time.
...
<span class="gp">... </span>        <span class="bp">self</span><span class="o">.</span><span class="n">pos</span> <span class="o">=</span> <span class="n">image</span><span class="o">.</span><span class="n">get_rect</span><span class="p">()</span><span class="o">.</span><span class="n">main</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="n">height</span><span class="p">)</span>
...
<span class="gp">... </span>        <span class="bp">self</span><span class="o">.</span><span class="n">pos</span> <span class="o">=</span> <span class="bp">self</span><span class="o">.</span><span class="n">pos</span><span class="o">.</span><span class="n">main</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="bp">self</span><span class="o">.</span><span class="n">speed</span><span class="p">)</span>
...
It positions the object and sets its speed. The main method moves the object
...
<span class="gp">... </span>    <span class="k">for</span> <span class="n">o</span> <span class="ow">in</span> <span class="n">objects</span><span class="p">:</span>
<span class="gp">... </span>        <span class="n">o</span><span class="o">.</span><span class="n">main</span><span class="p">()</span>
