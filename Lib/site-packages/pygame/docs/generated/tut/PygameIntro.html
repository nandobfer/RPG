...
<span class="linenos">17</span>    <span class="n">ballrect</span> <span class="o">=</span> <span class="n">ballrect</span><span class="o">.</span><span class="n">main</span><span class="p">(</span><span class="n">speed</span><span class="p">)</span>
...
check for user input, main the ball, and then draw the ball. If you are
...
we need to erase anything, why don't we just main the ball on the
...
the main towards higher level languages. Usually a game is split into
