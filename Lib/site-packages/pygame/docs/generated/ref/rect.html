...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="rect.html#pygame.Rect.main">pygame.Rect.main</a></div>
</td>
<td>—</td>
...
<td>—</td>
<td>resize and main a rectangle with aspect ratio</td>
</tr>
...
<p>The Rect object has several virtual attributes which can be used to main and
align the Rect:</p>
...
all other assignments main the rectangle without resizing it. Notice that
...
<p><span class="versionmodified added">New in pygame 1.9.2: </span>The Rect class can be subclassed. Methods such as <code class="docutils literal notranslate"><span class="pre">copy()</span></code> and <code class="docutils literal notranslate"><span class="pre">main()</span></code>
...
<dl class="py method definition">
<dt class="sig sig-object py title" id="pygame.Rect.main">
<span class="sig-name descname"><span class="pre">main</span></span><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#pygame.Rect.main" title="Permalink to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">moves the rectangle</span></div>
<div class="line"><span class="signature">main(x, y) -&gt; Rect</span></div>
</div>
...
<p>Same as the <code class="docutils literal notranslate"><span class="pre">Rect.main()</span></code> method, but operates in place.</p>
</dd></dl>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">resize and main a rectangle with aspect ratio</span></div>
